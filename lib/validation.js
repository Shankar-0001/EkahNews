...
export const validateArticle = (data) => {
    ...
    if (data.canonical_url) {
        try {
            const parsed = new URL(data.canonical_url, process.env.NEXT_PUBLIC_BASE_URL || 'https://ekahnews.com')
            const siteOrigin = new URL(process.env.NEXT_PUBLIC_BASE_URL || 'https://ekahnews.com').origin
